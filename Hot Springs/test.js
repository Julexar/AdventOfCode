...
function runPart1() {
    ...
    function damageRuns(arrangement) {
    ...
    const totalArrangements = records.map(r => r.possibleCount).reduce((a, b) => a + b);

    console.log(`Part 1 Solution: ${totalArrangements}`);
}
...
function runPart2() {
    ...
    console.log(`Part 2 Solution: ${totalArrangements}`);
}
